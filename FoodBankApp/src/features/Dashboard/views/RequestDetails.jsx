...
const RequestDetails = ({route}) => {
  ...
  const statusImage = {
    'En camino':
      'https://firebasestorage.googleapis.com/v0/b/bamx-cc64f.appspot.com/o/Mobile%2Ficons%2Fcamion.png?alt=media&token=36e60c65-f444-4e3b-be63-7f8d86f4ebb8&_gl=1*13a7sag*_ga*MjQ1OTk0NTYzLjE2OTIxOTcxOTI.*_ga_CW55HF8NVT*MTY5NzU1MTA2Ny4xNjAuMS4xNjk3NTUyMTI0LjMuMC4w',
    Entregado:
      'https://firebasestorage.googleapis.com/v0/b/bamx-cc64f.appspot.com/o/Mobile%2Ficons%2Fcheck.png?alt=media&token=a33b145d-ee7f-40f6-b7c0-4803a882235b&_gl=1*vqhh4b*_ga*MjQ1OTk0NTYzLjE2OTIxOTcxOTI.*_ga_CW55HF8NVT*MTY5NzU1MTA2Ny4xNjAuMS4xNjk3NTUyMzk5LjI1LjAuMA..',
    Cancelado:
      'https://firebasestorage.googleapis.com/v0/b/bamx-cc64f.appspot.com/o/Mobile%2Ficons%2Fcancelado.png?alt=media&token=83d60d6f-7601-4abd-aa18-08796baf593c&_gl=1*1b17px4*_ga*MjQ1OTk0NTYzLjE2OTIxOTcxOTI.*_ga_CW55HF8NVT*MTY5NzU1MTA2Ny4xNjAuMS4xNjk3NTUyMzgzLjQxLjAuMA..',
    Pendiente:
      'https://firebasestorage.googleapis.com/v0/b/bamx-cc64f.appspot.com/o/Mobile%2Ficons%2Fpendiente.png?alt=media&token=d6e6c8ec-ff1b-4086-b95f-81bba6ccf5e0&_gl=1*a7776s*_ga*MjQ1OTk0NTYzLjE2OTIxOTcxOTI.*_ga_CW55HF8NVT*MTY5NzU1MTA2Ny4xNjAuMS4xNjk3NTUyNDEyLjEyLjAuMA..',
  };
  ...
  const cancelRequest = () => {
    ...
    try {
      firestore()
        ...
        .then(() => {
          triggerAlert(
            'Cargamento cancelado',
            'El cargamento ha sido cancelado',
            'Ok',
          );
      ...
      triggerAlert(
        'Error',
        'Se produjo un error inesperado, intente de nuevo más tarde.',
        'Ok',
      );
    }
  };
      ...
      <SafeAreaView>
        ...
        <View style={styles.screen}>
          <View style={DefaultStyles.header}>
            ...
            <Text style={[DefaultStyles.poppinsTitle, {flex: 8}]}>
              Cargamento #{String(data.requestID).padStart(5, '0')}
            </Text>
          </View>
          <View></View>
          <View style={[styles.mainCardView, {padding: 32}]}>
            ...
            <View
              style={[DefaultStyles.flexColumn, {alignItems: 'flex-start'}]}>
              <Text style={DefaultStyles.poppinsRegular}>{userDoc.name}</Text>
              <Text style={DefaultStyles.poppinsRegular}>
                {userDoc.nameCorp}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.productHolder}>
                      ...
                      <View style={[styles.mainCardView]}>
                        <View style={styles.subCardView}>
                          <Image
                            ...
                            source={{uri: categoryImage[product.Type]}}
                          />
                        </View>
                        ...
                        <View>
                          <View>
                            ...
                            <Text
                              ...
                              {product.Quantity + ' ' + product.MeasuringUnit}
                            </Text>
                            <Text
                              style={[
                                DefaultStyles.poppinsRegular,
            ...
            <View style={{flexDirection: 'row', display: 'flex', gap: 16}}>
              <View style={styles.halfCardView}>
                <View
                  ...
                  <Image
                    ...
                    source={{uri: statusImage[data.status]}}
                  />
                </View>
              ...
              <View style={styles.halfCardView}>
                <Text
                  style={[DefaultStyles.poppinsMedium, {textAlign: 'center'}]}>
                ...
                <Text
                  style={[DefaultStyles.poppinsMedium, {textAlign: 'center'}]}>
                  {data.status === 'Cancelado' ? 'Cancelación' : 'Entrega'}
                </Text>
              </View>
            </View>
          </View>

          {data.status === 'Cancelado' || data.status === 'Entregado' ? null : (
            <Button
              content={'Cancelar cargamento'}
              bgColor={Colors.primary}
              fontColor={Colors.textSecondary}
              functionality={() => cancelRequest()}
            />
          )}
        </View>
